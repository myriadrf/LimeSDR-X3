...
There are four Dual-Channel 14-Bit, 160 Msps, analog-to-digital converters (ADS4246 – IC50, IC53, IC54 and IC56). ADC analog inputs are connected to baseband RX outputs of RF transceivers #2 and #3 (IC3 and IC5). Digital output pins are connected to FPGA.
...
.. tabs::
    ...
    .. tab:: LMS2 RX1 BB ADC
        ...
        .. list-table:: Table 5. 14-bit LMS2 RX1 BB ADC (IC50) digital interface
            :header-rows: 1
            :stub-columns: 1
    ...
    .. tab:: LMS2 RX2 BB ADC
        ...
        .. list-table:: Table 6. 14-bit LMS2 RX2 BB ADC (IC53) digital interface
            :header-rows: 1
            :stub-columns: 1
    ...
    .. tab:: LMS3 RX1 BB ADC
        ...
        .. list-table:: Table 7. 14-bit LMS3 RX1 BB ADC (IC54) digital interface
            :header-rows: 1
            :stub-columns: 1
    ...
    .. tab:: LMS3 RX2 BB ADC
        ...
        .. list-table:: Table 8. 14-bit LMS3 RX2 BB ADC (IC54) digital interface
            :header-rows: 1
            :stub-columns: 1

...
Fan voltage can be selected between 3.3V, 5V (default) and 12V via R186, R187 and R188 respectively as shown in Figure 11. Up to three fans can be connected to connectors: J18 (FPGA), J16 (RF) and J17 (spare).

.. figure:: /images/PCIe_5GRadio_v3.0_FanControl.png
  :width: 400
  
  Figure 11: Fan control circuit and voltage selection resistors